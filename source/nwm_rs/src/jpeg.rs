...
impl<'a> JpegShared<'a> {
    ...
    fn setCompInfos<'b: 'a>(&'b mut self, hq: u32, deltaProg: bool) -> (usize, f32) {
        ...
        let mcuRowsTop = jdiv_round_up(GSP_SCREEN_HEIGHT_TOP as usize, self.mcuColSize);
        self.mcusTop = (self.mcusPerRow * mcuRowsTop) as u16;
